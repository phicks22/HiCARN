...
import Models.HiCARN_1 as CARN
...
def hicarn_predictor(hicarn_loader, ckpt_file, scale, res_num, device):
...
if __name__ == '__main__':
    ...
    HiCARN_file = 'deephic_10kb40kb_c40_s40_b201_nonpool_human_K562_Chr3_40.npz'
    ...
    carn_hics = hicarn_predictor(carn_loader, ckpt_file, scale, res_num, device)
